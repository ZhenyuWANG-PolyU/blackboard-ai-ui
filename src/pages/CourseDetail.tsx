...
const CourseDetail = () => {
  ...
  const [weeklyContent, setWeeklyContent] = useState([
    ...
    { week: 4, title: "", date: "", materials: [], assignments: [], quizzes: [], surveys: [] },
    { week: 5, title: "", date: "", materials: [], assignments: [], quizzes: [], surveys: [] },
    { week: 6, title: "", date: "", materials: [], assignments: [], quizzes: [], surveys: [] },
    { week: 7, title: "", date: "", materials: [], assignments: [], quizzes: [], surveys: [] },
    { week: 8, title: "", date: "", materials: [], assignments: [], quizzes: [], surveys: [] },
    { week: 9, title: "", date: "", materials: [], assignments: [], quizzes: [], surveys: [] },
    { week: 10, title: "", date: "", materials: [], assignments: [], quizzes: [], surveys: [] },
